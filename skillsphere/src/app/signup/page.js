        ...
        >
            <div className="rounded-2xl flex items-start justify-center gap-4 flex-col bg-white dark:bg-[#10161F] shadow-2xl w-4/10 py-8 px-4">
                ...
                <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4'>
                    ...
                    <button
                        className='bg-black text-white border-white hover:bg-white hover:text-black hover:border-black w-full 
                    px-4 py-3 rounded-lg font-bold border transition-colors duration-300 hover:cursor-pointer'
                        type='submit'
                    >
                        Sign up
                    </button>
                ...
                <div className="w-full text-xs text-blue-500 flex justify-center">
                    <p>or <Link href={"/login"}><span className='underline'>Log in</span></Link> instead</p>
                </div>
            </div>
        </motion.main>
    )
